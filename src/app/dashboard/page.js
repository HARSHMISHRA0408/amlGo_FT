    ...
    <div className="min-h-screen bg-gray-100 p-8 font-sans">
        ...
        <header className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-gray-600">
              Logged in as: <b className="text-gray-800">{user.email}</b> (Role:{" "}
              <b className="text-gray-800">{user.role}</b>)
            </span>
            <button
        ...
        <main className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="flex flex-col md:flex-row md:justify-between items-start md:items-center mb-6 space-y-4 md:space-y-0 md:space-x-4">
            ...
            <div className="flex space-x-4 w-full md:w-auto">
              <Link
                href="/categories"
                className="bg-gray-200 text-gray-700 font-semibold px-3 py-3 rounded-lg shadow hover:bg-gray-300 transition w-full text-center"
              >
                Go to Categories
              </Link>
              <Link
      ...
      >
        ...
        <DialogActions>
          <Button
            onClick={handleClose}
            className="text-gray-500 hover:bg-gray-100 transition"
          >
            Cancel
          </Button>
          <Button
